...
* **Data Contributors** The authors of the following publications, especially Vytautas Gapsys and Christina E. M. Schindler.
   * `V. Gapsys et al., Large scale relative protein ligand binding affinities using non-equilibrium alchemy, Chem. Sci., 2020,11, 1140-1152 <https://doi.org/10.1039/C9SC03754C>`_
   * `Christina E. M. Schindler et al., Large-Scale Assessment of Binding Free Energy Calculations in Active Drug Discovery Projects, J. Chem. Inf. Model. 2020, 60, 11, 5457–5474 <https://doi.org/10.1021/acs.jcim.0c00900>`_

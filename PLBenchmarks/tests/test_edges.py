...
def test_edge():
    ...
    ddg = (
        ligs[f"lig_{edg._data[1]}"]._data[("DerivedMeasurement", "dg")]
        - ligs[f"lig_{edg._data[0]}"]._data[("DerivedMeasurement", "dg")]
    )
    e_ddg = np.sqrt(
        ligs[f"lig_{edg._data[1]}"]._data[("DerivedMeasurement", "e_dg")] ** 2
...
def test_edgeSet():
    ...
    for k, edg in edgSet.items():
        ...
        ddg = (
            ligSet[f"lig_{edg._data[1]}"]._data[("DerivedMeasurement", "dg")]
        ...
        e_ddg = np.sqrt(
            ligSet[f"lig_{edg._data[1]}"]._data[("DerivedMeasurement", "e_dg")] ** 2
    ...
    for k, edg in df.iterrows():
        ...
        ddg = (
            ligSet[f"lig_{edg[1]}"]._data[("DerivedMeasurement", "dg")]
        ...
        e_ddg = np.sqrt(
            ligSet[f"lig_{edg[1]}"]._data[("DerivedMeasurement", "e_dg")] ** 2
